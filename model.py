...
class DQN(nn.Module):
    ...
    def forward(self, x):
        ...
        # Inputs: x defines the observation of the agent : x is a vector of size (num_states) where each element of the
        # vector corresponds to a cell in the state.
        
        # Return: return the output of the neural network (a tensor of (num_actions) values)
        return logits
